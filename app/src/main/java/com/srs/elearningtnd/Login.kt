...
import com.srs.elearningtnd.R.string.app_name
...
class Login : AppCompatActivity() {
    ...
    private fun initBt(){
        ...
        btMasuk.setOnClickListener {
            ...
            val u = etUser.text.toString().toLowerCase(Locale.getDefault())
...
//                    startActivity(intent)
    ...
    private fun offlineAuth(){
        ...
        val username = etUser.text.toString().toLowerCase(Locale.getDefault())
